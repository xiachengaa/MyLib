...
//        NSLog(@"placeHodlerLabel:%@",_PlaceholderLabel);
//        NSLog(@"placeHolder:%@",_placeholder);
//        NSLog(@"hiden:%li",(long)_PlaceholderLabel.hidden);
...
//    _PlaceholderLabel.frame = CGRectMake(0, 0, 40, 30);
//    NSLog(@"placeHolder:%@",placeholder);
//    NSLog(@"isHidden:%li",(long)_PlaceholderLabel.hidden);
}
